...
require_once t3lib_extMgm::extPath('user_events') . '/Classes/Model/RepositoryInterface.php';

require_once t3lib_extMgm::extPath('user_events') . '/Classes/Utility/PibaseMethodsProxy.php';

abstract class user_events_Model_PibaseRepository extends user_events_Utility_PibaseMethodsProxy implements user_events_Model_RepositoryInterface {
