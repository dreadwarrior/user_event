...
if (TYPO3_MODE === 'BE') {
	$TBE_MODULES_EXT['xMOD_db_new_content_el']['addElClasses']['user_events_Utility_ContentElementWizard'] = t3lib_extMgm::extPath($_EXTKEY) . 'Classes/Utility/ContentElementWizard.php';
}
